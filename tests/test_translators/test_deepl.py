...
from ifuntrans.translators.exceptions import AuthorizationException


@patch("ifuntrans.translators.deepl.requests")
...
@patch("ifuntrans.translators.deepl.requests.get")
