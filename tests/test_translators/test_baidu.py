...
from ifuntrans.translators import BaiduTranslator
from ifuntrans.translators.exceptions import BaiduAPIerror


@patch("ifuntrans.translators.baidu.requests")
...
@patch("ifuntrans.translators.baidu.requests.get")
