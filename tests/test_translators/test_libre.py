...
"""Tests for `ifuntrans.translators` package."""

import pytest

from ifuntrans.translators import LibreTranslator, exceptions
from ifuntrans.translators.constants import LIBRE_LANGUAGES_TO_CODES
