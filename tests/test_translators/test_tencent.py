...
from ifuntrans.translators import TencentTranslator
from ifuntrans.translators.exceptions import TencentAPIerror


@patch("ifuntrans.translators.tencent.requests")
